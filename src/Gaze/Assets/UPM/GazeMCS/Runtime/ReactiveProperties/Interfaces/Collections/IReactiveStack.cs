...
namespace Gaze.MCS
{
    public interface IReactiveStack<T> : IReadOnlyCollection<T>, IChangeable<IReactiveStack<T>>, IClearable<IReactiveStack<T>>, IPeekable<T>, IReleasable, IResettable
    {
        /// <summary>
        ...
        /// <returns>The ReactiveStack itself</returns>
        IReactiveStack<T> SafeBindOnPushAction(IDestroyable destroyable, Action<T> action);
        /// <summary>
        ...
        /// <returns>The ReactiveStack itself</returns>
        IReactiveStack<T> SafeBindOnPopAction(IDestroyable destroyable, Action<T> action);
    }
}
