...
namespace Gaze.MCS
{
    public interface IReactiveQueue<T> : IReadOnlyCollection<T>, IChangeable<IReactiveQueue<T>>, IPeekable<T>, IClearable<IReactiveQueue<T>>, IReleasable, IResettable
    {
        /// <summary>
        ...
        IReactiveQueue<T> SafeBindOnEnqueueAction(IDestroyable destroyable, Action<T> action);
        /// <summary>
        ...
        IReactiveQueue<T> SafeBindOnDequeueAction(IDestroyable destroyable, Action<T> action);
